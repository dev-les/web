...
let project = ref({});
let projects = [
{name: 'Drop-Shop.io', opt:"DSIO", img:require('../assets/images/dropshoplogo.png'),gif:require('../assets/gifs/dropshop.gif'), description:'Automated Shopify store for social media animated banners.',urlName:'drop-shop.io', url:'https://drop-shop.io/', tech:['liquid', 'Express.js','Node.js','Shopify Admin API', 'Pub Sub', 'Clound Functions', 'Send Grid', 'Nexrender', 'Typescript', 'Firebase']},
{name: 'Spotify VR Player', opt:"SVRP", img:require('../assets/images/spotifyVR.png'),gif:require('../assets/gifs/spotifyvr.gif'), description:'Web app spotify player that lets you connect to your spotify account and play music in a metaverse.', vid:'https://youtu.be/a3mAyD_UNoY', tech:['React.js', 'Express.js','Node.js','Spotify API', 'Spotify SDK']},
